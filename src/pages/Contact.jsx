                    ...
                    <div className="contact-card w-full max-w-full overflow-hidden bg-white border-2 border-black rounded-[24px] md:rounded-[40px] p-6 sm:p-10 md:p-12 shadow-[8px_8px_0px_var(--color-accent-green-mid)] md:shadow-[20px_20px_0px_var(--color-accent-green-mid)]">
                        <form className="space-y-6 md:space-y-8" onSubmit={(e) => e.preventDefault()}>
                            <div className="grid gap-2">
                                ...
                                <input type="text" className="w-full bg-transparent border-b-2 border-black/10 py-3 md:py-4 focus:border-brand-green outline-none font-bold text-base md:text-lg transition-colors placeholder:text-black/20" placeholder="Name..." />
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                <textarea rows="3" className="w-full bg-transparent border-b-2 border-black/10 py-3 md:py-4 focus:border-brand-green outline-none font-bold text-base md:text-lg transition-colors resize-none placeholder:text-black/20" placeholder="Message..."></textarea>
                            </div>

                            <button
                                data-cursor="SEND"
                                className="w-full bg-black text-white py-5 md:py-8 rounded-full font-bold text-lg md:text-xl hover:bg-brand-green transition-all uppercase flex items-center justify-center gap-4 group mt-4 md:mt-12"
                            >
