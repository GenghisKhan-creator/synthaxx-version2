...
const Portfolio = () => {
  ...
  return (
    <div
      ref={container}
      className="pt-32 pb-20 px-4 min-h-screen overflow-hidden"
    >
      <SEO
        title="Case Studies"
      ...
      <div className="max-w-[1400px] mx-auto">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-end border-b border-black pb-4">
                <div>
                  <h3 className="text-3xl font-bold uppercase group-hover:text-brand-green transition-colors">
                    {project.title}
                  </h3>
        ...
        <div className="mt-40 text-center">
          <div className="inline-block relative">
            <div className="text-[15vw] font-bold leading-none tracking-tighter uppercase opacity-5">
              Synthaxx
            </div>
